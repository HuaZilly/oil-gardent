...
?>
<div class="actions">
	<?php if ($md_review_count > 1) : ?><span class="btn secondary" id="see-all-reviews">See all reviews</span><?php endif; ?>
	<!-- data-js="bc-product-review-write" is required -->
	<button class="btn primary bc-product-review__write-btn" data-js="bc-product-review-write">
...
<div class="bc-product-review-form-custom">
	<h3 class="bc-product-review-form__title"> <?php echo esc_html( 'Write A Review', 'bigcommerce' ); ?></h3>
	<form action="" enctype="multipart/form-data" method="post" class="bc-form">
		...
		<div class="bc-form__actions bc-form__actions--review">
			<button
					class="btn primary bc-btn--review"
					aria-label="<?php esc_html_e( 'Submit', 'bigcommerce' ); ?>"
					type="submit"
			><?php esc_html_e( 'Post review', 'bigcommerce' ); ?></button>
			<!-- data-js="bc-product-review-cancel-write" is required -->
			<button type="reset" class="btn secondary bc-product-review__cancel-write-btn" data-js="bc-product-review-cancel-write">
