				...
				<?php if ( $image_ids ) {
					foreach ( $image_ids as $image_id ) { ?>
						...
						<div class="swiper-slide bc-product-gallery__image-slide">
							<img src="<?php echo esc_url( wp_get_attachment_image_url( $image_id, /*$image_size*/'full' ) ); ?>" itemprop="image" data-zoom="<?php echo esc_url( wp_get_attachment_image_url( $image_id, 'full' ) ); ?>"
									 alt="<?php echo $alt; //esc_attr( trim( strip_tags( get_post_meta( $image_id, '_wp_attachment_image_alt', true ) ) ) ); ?>">
						</div>
					<?php }
				} else { ?>
					<div class="swiper-slide bc-product-gallery__image-slide">
						...
						<a class="swiper-slide bc-product-gallery__thumb-slide" data-js="bc-gallery-thumb-trigger"
						   data-index="<?php echo (int) $index; ?>">
							<img src="<?php echo esc_url( wp_get_attachment_image_url( $image_id, $thumbnail_size ) ); ?>"
							     alt="<?php echo $alt; //echo esc_attr( trim( strip_tags( get_post_meta( $image_id, '_wp_attachment_image_alt', true ) ) ) ); ?>">
						</a>
					<?php } ?>
				</div>
			</div>
