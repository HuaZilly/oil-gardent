			...
			<div class="bc-account-login__form-inner">
				...
				<form class="bc-form bc-form-2col bc-account-form--register <?php if ( ! empty( $errors ) ) { echo 'bc-form--has-errors'; } ?>" action="" enctype="multipart/form-data" method="post" data-js="bc-dynamic-fields">
					...
					<p class="label-placeholder">
						<input type="email" name="bc-register[email]" id="bc-account-register-email" class="placeholder-control" value="<?php echo esc_html( $defaults[ 'email' ] ); ?>" data-form-field="bc-form-field-email">
						<label><?php echo esc_html( __( 'Email Address', 'bigcommerce' ) ); ?></label>
					</p>
					<p class="label-placeholder">
						<input type="password" name="bc-register[new_password]" id="bc-account-register-password" class="placeholder-control" value=""  data-form-field="bc-form-field-new_password">
						<label><?php echo esc_html( __( 'Password', 'bigcommerce' ) ); ?></label>
					</p>
					<p class="label-placeholder">
						<input type="password" name="bc-register[confirm_password]" id="bc-account-register-confirm-password" class="placeholder-control" value=""  data-form-field="bc-form-field-confirm_password">
						<label class="bc-form-control-required"><?php echo esc_html( __( 'Confirm Password', 'bigcommerce' ) ); ?></label>
					</p>
					...
					<div style="display: none;">
						<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'first_name', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-firstname">
							...
							<input type="text" name="bc-register[first_name]" id="bc-account-register-firstname" value="##TO-BE-FILLED##"  data-form-field="bc-form-field-first_name">
						</label>
						...
						<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'last_name', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-lastname">
							...
							<input type="text" name="bc-register[last_name]" id="bc-account-register-lastname" value="##TO-BE-FILLED##"  data-form-field="bc-form-field-last_name">
						</label>
						...
						<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'street_1', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-street1">
							...
							<input type="text" name="bc-register[street_1]" id="bc-account-register-street1" value="##TO-BE-FILLED##"  data-form-field="bc-form-field-street_1">
						</label>
						...
						<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'street_2', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-street2">
							...
							<input type="text" name="bc-register[street_2]" id="bc-account-register-street2" value="##TO-BE-FILLED##" data-form-field="bc-form-field-street_2">
						</label>
						...
						<label class="bc-form__control bc-form-2col__control bc-form-2col__control--left <?php if ( in_array( 'company', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-company">
							...
							<input type="text" name="bc-register[company]" id="bc-account-register-company" value="##TO-BE-FILLED##" data-form-field="bc-form-field-company">
						</label>
						...
						<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'city', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-city">
							...
							<input type="text" name="bc-register[city]" id="bc-account-register-city" value="##TO-BE-FILLED##" data-form-field="bc-form-field-city">
						</label>
						...
						<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'zip', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-zip">
							...
							<input type="text" name="bc-register[zip]" id="bc-account-register-zip" value="00000"  data-form-field="bc-form-field-zip">
						</label>
						...
						<label class="bc-form__control bc-form-2col__control bc-form-2col__control--right <?php if ( in_array( 'phone', $errors ) ) { echo esc_attr( $error_class ); } ?>" for="bc-account-register-phone">
							...
							<input type="tel" name="bc-register[phone]" id="bc-account-register-phone" value="00000"  data-form-field="bc-form-field-phone">
						</label>
					</div>

					<div class="flex">
						<div class="faux-checkbox">
							<input name="newsletter" type="checkbox" id="bc-account-register-newsletter" value="yes" />
							<span></span>
							<label for="newsletter">Register to receive newsletters</label>
						</div>
					</div>

					<input type="hidden" name="bc-register[admin_bar_front]" value="0" />
					<button class="btn primary" aria-label="<?php esc_html_e( 'Signup', 'bigcommerce' ); ?>" type="submit"><?php esc_html_e( 'Signup', 'bigcommerce' ); ?></button>
				</form>
			</div>
		</div>
	</section>
