...
<div class="inner">
	...
	<form action="" enctype="multipart/form-data" method="post" class="bc-form bc-form-2col <?php if ( ! empty( $errors ) ) { echo 'bc-form--has-errors'; } ?>" data-js="bc-dynamic-fields" data-form-type="bc-address-form">
		...
		<div class="bc-account-address-form-actions">
			<button class="btn primary bc-account-address-form-save" aria-label="<?php __( 'Save Address', 'bigcommerce' ); ?>" type="submit" data-js="bc-account-address-form-save"><?php echo esc_html( __( 'Save', 'bigcommerce' ) ); ?></button>
			<!-- data-js="bc-account-address-form-cancel" is required -->
			<button class="btn secondary bc-account-address-form-cancel" aria-label="<?php __( 'Cancel Editing', 'bigcommerce' ); ?>" type="button" data-js="bc-account-address-form-cancel"><?php echo esc_html( __( 'Cancel', 'bigcommerce' ) ); ?></button>
		</div>
