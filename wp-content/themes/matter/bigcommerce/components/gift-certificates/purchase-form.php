			...
			<div class="bc-form__row">
				...
				<div class="bc-form__col">
					<label for="bc-gift-purchase-amount" class="bc-form__control">
						<span class="bc-form__label bc-gift-purchase__form-label">Select Amount:</span>
						<select name="select-amount" class="select" id="select-amount" style="font-size: 16px;" required>
					...
					<label for="bc-gift-purchase-amount" class="bc-form__control amount-block <?php if ( in_array( 'amount', $errors ) ) { echo esc_attr( $error_class ); } ?>">
						...
						<input type="text" name="bc-gift-purchase[amount]" id="bc-gift-purchase-amount" value="<?php echo '25'; //echo esc_attr( $defaults[ 'amount' ] ); ?>" data-form-field="bc-form-field-amount" />
					</label>
